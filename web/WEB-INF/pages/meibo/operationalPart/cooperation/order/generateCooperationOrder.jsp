...
<div class="ftitle">
	订单详情列表<span class="form_desc">从订单详情列表中生成外发单</span>
</div>
<table id="tt_listOrderItem" class="easyui-datagrid" style="width: 770px; height: 305px;"
	data-options="idField:'id',toolbar:'#tb_listOfferItem',singleSelect:true,
	...
	<thead>
		<tr>
			...
			<th data-options="field:'xx',width:100,formatter:cooperatorOrderformatter">外发单号</th>
...
<div id="tb_listOfferItem">
	<a href="#" class="easyui-linkbutton" iconCls="icon-system" plain="true" onclick="generateCooperationOrder();">生成外发单</a>
</div>