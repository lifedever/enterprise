...
<div id="tb_buyrequest" style="padding: 5px; height: auto">
	<div style="margin-bottom: 5px">
		<a href="#" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="addBuyrequest();">新增</a>
		<a href="#" class="easyui-linkbutton" iconCls="icon-edit" plain="true" onclick="editBuyrequest();">编辑</a>
		<a href="#" class="easyui-linkbutton" iconCls="icon-del" plain="true" onclick="delBuyrequest();">删除</a>
