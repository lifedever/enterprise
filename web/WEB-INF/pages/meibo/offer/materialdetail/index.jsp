...
<table id="tt_indexMaterial" class="easyui-datagrid" style="width: 800px; height: 330px;"
	data-options="idField:'id',
		collapsible:true,rownumbers:true,url:'/meibo/offer/materialdetail/listByItemId.html?itemId=${itemId }',
