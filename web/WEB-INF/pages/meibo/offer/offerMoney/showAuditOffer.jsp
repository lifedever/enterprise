...
<div class="ftitle">
	报价信息<span class="form_desc">产品或样品详细报价信息</span>
</div>
...
<table id="tt_itemShow" class="easyui-datagrid" style="width: 750px; height: 250px;"
...
<div id="tb_itemAudit">
	<a href="#" class="easyui-linkbutton" iconCls="icon-ask" plain="true" onclick="askAuditForm();">是否同意报价</a>
</div>