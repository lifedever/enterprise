...
<table id="tt_managerAuditOffer" class="easyui-datagrid" style="width: 770px; height: 370px;"
...
<div id="tb_managerAuditOffer">
	<a href="#" class="easyui-linkbutton" iconCls="icon-info" plain="true" onclick="itemAudit();">点击进行报价或审批</a>
</div>
