...
<div style="font-size: 14px;" id="print">
	...
	<table style="border-collapse: collapse; margin-left: 20px; border-width: 0px;" border="1" width="95%">
		<tr>
			<td style="border-width: 0px;padding-bottom: 8px;" width="50%"><strong>名称：</strong>${worksheet.productName }</td>
			<td style="border-width: 0px;padding-bottom: 8px;" width="50%"><strong>编号：</strong>${worksheet.productNo }</td>
		</tr>
		<tr>
			<td style="border-width: 0px;padding-bottom: 8px;"><strong>规格：</strong>${worksheet.contourSize }</td>
			<td style="border-width: 0px;padding-bottom: 8px;"><strong>数量：</strong>${worksheet.productCount }</td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2" style="border-width: 0px;padding-bottom: 8px;">
				<input type="hidden" id="startDate" name="startDate" readonly="readonly" value="<fmt:formatDate value="${worksheet.startDate}" pattern="yyyy年MM月dd日00时" />"/>
				<fmt:formatDate value="${worksheet.startDate}" pattern="yyyy年MM月dd日00时" />
				至<input type="hidden" id="endDate"  name="endDate" readonly="readonly"  value="<fmt:formatDate value="${worksheet.endDate}" pattern="yyyy年MM月dd日00时" />"/>
				<fmt:formatDate value="${worksheet.endDate}" pattern="yyyy年MM月dd日00时" />，
				共计<label id="realUse2" ></label>
			</td>
		</tr>
		<tr>
