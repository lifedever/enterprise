...
<table id="tt_materialOfferItem" class="easyui-datagrid" style="width: 870px; height: 270px;"
	data-options="idField:'id',toolbar:'#tb_order',
...
<div id="tb_order">
<a href="#" class="easyui-linkbutton" iconCls="icon-order" plain="true" onclick="prepareMaterialAdd();">下备料单</a>
</div>
