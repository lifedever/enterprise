...
<body>
	<div class="easyui-tabs" style="" data-options="fit:true">
		<div title="订单审批管理" style="padding: 3px">
			<table id="tt_auditOrder" class="easyui-datagrid"
			...
			url:'/meibo/order/listContent.html?f_signState=1',pagination:true,singleSelect : true,cache:false">
				<thead>
					<tr>
						...
						<th data-options="field:'signState',width:180,formatter:signFormatter">签单信息</th>
						<th data-options="field:'isAudit',width:60,formatter:formatAuditState">审批状态</th>
						...
						<th data-options="field:'startDate',width:100,formatter:formatDate">开始时间</th>
						<th data-options="field:'endDate',width:100,formatter:formatDate">结束时间</th>
						<th data-options="field:'createDate',width:100,formatter:formatDate" sortable="true">创建时间</th>
					</tr>
				</thead>
			</table>
		</div>
