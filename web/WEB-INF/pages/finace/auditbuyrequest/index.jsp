...
<body>
	<div class="easyui-tabs" style="" data-options="fit:true">
		<div title="请购管理" style="padding: 3px">
			<table id="tt_buyRequest" class="easyui-datagrid" data-options="fit:true,idField:'id',toolbar:'#tb_buyrequest',collapsible:true,rownumbers:true,url:'/meibo/storeroom/buyrequest/listContent.html',pagination:true,singleSelect : true,cache:false">
				<thead>
					<tr>
						...
						<th data-options="field:'totalPrice',width:150,formatter:formatMoney">支付金额</th>
