...
<script type="text/javascript">
	var url = "/finace/account/listContent.html?accountType=0";
	$(function() {
		$('#tt_account').datagrid({
			title : '',
			iconCls : 'icon-edit',
...
<body>
	<div class="easyui-tabs" style="" data-options="fit:true">
		<div title="现金账户" style="padding: 3px">
			<table id="tt_account">
			</table>
		</div>
	</div>
  ...
  <div class="easyui-window" id="win_newTotalAccount" data-options="title:'现金日记账',closed:true,modal:true,iconCls:'icon-save',cache:false" style="width: 700px; height: 400px; padding: 10px;"></div>
  <div class="easyui-window" id="win_newDayAccount" data-options="title:'现金日记账',closed:true,modal:true,iconCls:'icon-save',cache:false" style="width: 700px; height: 400px; padding: 10px;"></div>
	...
	<script type="text/javascript">
		...
		function onClickRow(rowIndex, rowData) {
			...
			}).window('open').window('setTitle','现金日记账');
		}
		//查看明细
		function showItems(){
			var row = $('#tt_account').datagrid('getSelected');
