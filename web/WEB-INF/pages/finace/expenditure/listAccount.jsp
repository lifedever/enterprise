...
<script type="text/javascript">
	...
	function addAccount() {
		...
		if (row) {
			...
			$('#accountIdNo').val(row.id);
			$('#accountIdTotal').val(row.id);
			$('#accountNameTotal').val(row.accountName);
			$('#accountNameNo').val(row.accountName);
			$('#accountName11').val(row.accountName);
			$('#accountName22').val(row.accountName);
